...
public class VerfifyAssignedRoleAsUser extends itemVerification{
	String desc = "To Verify if user can access CF according to User as a role";
	int rowNo=27;
	...
	{
		TestLog.info("************** Test Case 27 :  VerfifyAssignedRoleAsUser Starting :- **************");
		openBrowser();
		openURL() ;
	...
	//Creation of Organation for non admin login
		...
		public Object[][] creatOrg() throws BiffException  {
			Object[][] arrayObject = xls_reader.getExcelData(config_getproperty("testDataPath") + "VerifyUserCanAssignesAsUser.xls","organization");
			return arrayObject;
		}
		...
		//Creation of USER and assign role 
		 		...
		 		public Object[][] creatUser() throws BiffException  {
		 				Object[][] arrayObject = xls_reader.getExcelData(config_getproperty("testDataPath") + "VerifyUserCanAssignesAsUser.xls","user");
		 				return arrayObject;
		 		}
				...
				public void generateReport()
				{
					...
					TestLog.info("************** Test Case 27  ENDS  VerfifyAssignedRoleAsUser:- **************");
				}	
