...
public class VerfifyAssignedRoleAsBillingManager extends itemVerification{
	String desc = "To Verify if user can access CF according to billing Manager as a role";
	int rowNo=25;
	...
	{
		TestLog.info("************** Test Case 25 :  VerfifyAssignedRoleAsBillingManager Starting :- **************");
		openBrowser();
		openURL() ;
	...
	//Creation of Organation for non admin login
		...
		public Object[][] creatOrg() throws BiffException  {
			Object[][] arrayObject = xls_reader.getExcelData(config_getproperty("testDataPath") + "VerifyUserCanAssignedAsBillingManager.xls","organization");
			return arrayObject;
		}
		...
		//Creation of USER and assign role 
		 		...
		 		public Object[][] creatUser() throws BiffException  {
		 				Object[][] arrayObject = xls_reader.getExcelData(config_getproperty("testDataPath") + "VerifyUserCanAssignedAsBillingManager.xls","user");
		 				return arrayObject;
		 		}
				...
				public void generateReport()
				{
					...
					TestLog.info("************** Test Case 25  ENDS  VerfifyAssignedRoleAsBillingManager:- **************");
				}	
