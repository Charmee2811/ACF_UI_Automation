...
public class VerfifyAssignedRoleAsManager extends itemVerification {
	String desc = "To Verify if user can access CF according to manager as a role";
	int rowNo=24;
	...
	{
		TestLog.info("************** Test Case 24 :  VerfifyAssignedRoleAsManager Starting :- **************");
		openBrowser();
		openURL() ;
	...
	//Creation of Organation for non admin login
		...
		public Object[][] creatOrg() throws BiffException  {
			Object[][] arrayObject = xls_reader.getExcelData(config_getproperty("testDataPath") + "VerifyUserCanAssignedAsManager.xls","organization");
			return arrayObject;
		}
		...
		//Creation of USER and assign role 
		 		...
		 		public Object[][] creatUser() throws BiffException  {
		 				Object[][] arrayObject = xls_reader.getExcelData(config_getproperty("testDataPath") + "VerifyUserCanAssignedAsManager.xls","user");
		 				return arrayObject;
		 		}
				...
				public void generateReport()
				{
					...
					TestLog.info("************** Test Case 24  ENDS  VerfifyAssignedRoleAsManager:- **************");
				}	
}
